...
public class CookingRecipeSerializer implements RecipeSerializer<CookingRecipe> {
    ...
    @Override
    public CookingRecipe read(Identifier id, JsonObject json) {
        ...
        if (inputItems.size() > CookingRecipe.INPUT_SLOTS) {
            ...
            return new CookingRecipe(id, groupIn, inputItems, outputIn, additionalOutputs, cookTimeIn, priority);
        }
    }

    @Override
    public CookingRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        return new CookingRecipe(id, groupIn, ingredientList, outputIn, additionalOutputIn, cookTimeIn, priority);
    }

    @Override
    public void write(PacketByteBuf buf, CookingRecipe recipe) {
