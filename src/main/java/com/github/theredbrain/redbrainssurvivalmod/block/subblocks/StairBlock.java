...
public class StairBlock extends AbstractSubBlock {
    ...
    public StairBlock(BlockState baseBlockState, Settings settings) {
        ...
        this.setDefaultState((BlockState)((BlockState)((BlockState)((BlockState)((BlockState)this.stateManager.getDefaultState()).with(FACING, Direction.SOUTH)).with(HALF, BlockHalf.BOTTOM)).with(ORIENTATION, Orientation.HORIZONTAL)).with(WATERLOGGED, false));
    }
