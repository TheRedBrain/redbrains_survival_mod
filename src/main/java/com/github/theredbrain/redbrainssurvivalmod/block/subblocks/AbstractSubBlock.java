...
public abstract class AbstractSubBlock extends Block implements Waterloggable {
    ...
    public AbstractSubBlock(BlockState baseBlockState, Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)((BlockState)((BlockState)((BlockState)this.stateManager.getDefaultState()).with(FACING, Direction.SOUTH)).with(ORIENTATION, Orientation.HORIZONTAL)).with(WATERLOGGED, false));
        this.baseBlock = baseBlockState.getBlock();
        this.baseBlockState = baseBlockState;
    }

    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(new Property[]{FACING, ORIENTATION, WATERLOGGED});
    }
