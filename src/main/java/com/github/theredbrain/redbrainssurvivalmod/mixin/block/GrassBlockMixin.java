...
//            return false;
//        } else if ((state.isOf(BlocksRegistry.LOOSE_DIRT_SLAB.get()) || state.isOf(BlocksRegistry.DIRT_SLAB.get()) || state.isOf(BlocksRegistry.GRASS_SLAB_SPARSE.get())) && state.get(Properties.WATERLOGGED)) {
//            return false;
//        } else {
...
//
//                    if ((world.getBlockState(blockPos).isOf(Blocks.DIRT) || world.getBlockState(blockPos).isOf(BlocksRegistry.LOOSE_DIRT.get()) || world.getBlockState(blockPos).isOf(BlocksRegistry.GRASS_BLOCK_SPARSE.get())) && canSpread(fullBlockState, world, blockPos)) {
...
//                    } else if ((world.getBlockState(blockPos).isOf(BlocksRegistry.DIRT_SLAB.get()) || world.getBlockState(blockPos).isOf(BlocksRegistry.LOOSE_DIRT_SLAB.get()) || world.getBlockState(blockPos).isOf(BlocksRegistry.GRASS_SLAB_SPARSE.get())) && !(world.getBlockState(blockPos).get(Properties.WATERLOGGED)) && canSpread(slabBlockState, world, blockPos)) {
