...
//        this.soundEvent = new SoundEvent(new Identifier(RedBrainsSurvivalMod.MOD_ID, this.pathName));
//    }
//
//    public static void registerAll() {
//        for (SoundsRegistry value : values()) {
//            Registry.register(Registry.SOUND_EVENT, new Identifier(RedBrainsSurvivalMod.MOD_ID, value.pathName), value.soundEvent);
//        }
//    }
//
