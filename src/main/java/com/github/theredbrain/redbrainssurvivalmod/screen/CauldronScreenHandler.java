...
//    private final SoulforgeInventory soulforgeInventory;
    ...
    public CauldronScreenHandler(int syncId, PlayerInventory playerInventory/*, DefaultedList<ItemStack> soulforgeInventoryStacks*/, ScreenHandlerContext context) {
...
//        this.soulforgeInventory = new SoulforgeInventory(this, soulforgeInventoryStacks, 4, 4); // TODO moulds stay in their slots
    ...
    public void onContentChanged(Inventory inventory) {
        this.context.run((world, pos) -> CauldronScreenHandler.updateResult(this, world, this.player, this.input, this.result));
    }
...
//        this.context.run((world, pos) -> this.dropInventoryButMouldsStay(player, this.soulforgeInventory));
    ...
    public boolean canUse(PlayerEntity player) {
        return CauldronScreenHandler.canUse(this.context, player, BlocksRegistry.SOULFORGE.get());
    }
